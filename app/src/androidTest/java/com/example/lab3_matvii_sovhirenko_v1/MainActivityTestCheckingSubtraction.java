...
public class MainActivityTestCheckingSubtraction {
    ...
    @Test
    public void mainActivityTestCheckingSubtraction() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.calculatorDisplay), withText("11"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.TableLayout.class))),
                        isDisplayed()));
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.subDisplay), withText("11-"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.TableLayout.class))),
                        isDisplayed()));
        textView3.check(matches(withText("11-")));
        ...
        ViewInteraction textView4 = onView(
                allOf(withId(R.id.calculatorDisplay), withText("-81"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.TableLayout.class))),
                        isDisplayed()));
        textView4.check(matches(withText("-81")));
    }
